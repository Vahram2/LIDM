%**************************************************************************
% fc_subtreeCreator divides 
%**************************************************************************
function [subtrees,subnodes]=fc_subtreeCreator(Options,max_tree,tank_tree,root_id)
...
for n = 1 : length(node1)
    ...
    subnodes{n} = Options.JPSO_input.node(:,(ismember(Options.JPSO_input.node(1,:),subnodes{n})) );
end
