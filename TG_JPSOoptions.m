function Options = TG_JPSOoptions
%**************************************************************************
%JPSO_input

Options.JPSO_input.max_tree = ...
...
Options.JPSO_input.nnodes = 20;
Options.JPSO_input.tank_id = [5,16];
Options.JPSO_input.tank_head= [102,96];
Options.JPSO_input.Iterations  = 100;
Options.JPSO_input.SwarmSize = 20;
Options.JPSO_input.c = [0.7,0.1,0.1,0.1];
Options.JPSO_input.DC1=0.7;
Options.JPSO_input.Nhood=1;
%**************************************************************************
%LIDM_input
%--------------------------------------------------------------------------
%-> input
